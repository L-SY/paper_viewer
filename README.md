...
面向研究课题组的月度论文提交、AI 中文概览与评阅、导师反馈系统。
...
评分锚点、跨专业解释和规范验证方案见 [AI 评分规范 v1.1](docs/ai-review-rubric-v1.1.md)。7 分表示合格且清楚的月度科研论文；本项信息充分程度同时向导师和学生展示，但不参与总分。

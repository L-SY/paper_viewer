...
export default async function OnboardingPage({ searchParams }: { searchParams: Promise<{ invite?: string | string[] }> }) {
  ...
  return <AuthShell eyebrow="个人资料" title="完善个人资料"><OnboardingForm initialInvite={invite || ""} initialDisplayName={displayName} initialDiscipline={discipline} initialRole={role} /></AuthShell>;
}
